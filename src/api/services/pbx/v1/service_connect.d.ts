...
/**
 * @generated from service api.services.pbx.v1.PBXService
 */
export declare const PBXService: {
  readonly typeName: "api.services.pbx.v1.PBXService",
  readonly methods: {
    /**
     ...
     *
     * @generated from rpc api.services.pbx.v1.PBXService.QueryPbxUsers
     */
     ...
     *   - grpc.Unavailable: The operation is currently unavailable. Likely a transient issue with a downstream service.
     *
     * @generated from rpc api.services.pbx.v1.PBXService.QueryRingGroups
     */
     ...
     *   - grpc.Unavailable: The operation is currently unavailable. Likely a transient issue with a downstream service.
     *
     * @generated from rpc api.services.pbx.v1.PBXService.UpdatePbxUser
     */
     ...
     *   - grpc.Unavailable: The operation is currently unavailable. Likely a transient issue with a downstream service.
     *
     * @generated from rpc api.services.pbx.v1.PBXService.UpdateRingGroup
     */
     ...
     *   - grpc.Unavailable: The operation is currently unavailable. Likely a transient issue with a downstream service.
     *
     * @generated from rpc api.services.pbx.v1.PBXService.CreateRingGroup
     */
     ...
     *   - grpc.Unavailable: The operation is currently unavailable. Likely a transient issue with a downstream service.
     *
     * @generated from rpc api.services.pbx.v1.PBXService.DeleteRingGroup
     */
     ...
     *   - grpc.Unavailable: The operation is currently unavailable. Likely a transient issue with a downstream service.
     *
     * @generated from rpc api.services.pbx.v1.PBXService.AssignRandomExtension
     */

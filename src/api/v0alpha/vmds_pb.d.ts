 ...
 */
export declare class DownloadSpecifiedMessagesReq extends Message<DownloadSpecifiedMessagesReq> {
  /**
   * @generated from field: repeated api.v0alpha.DownloadSpecifiedMessagesReq.MessageReq messages = 1;
   */
  messages: DownloadSpecifiedMessagesReq_MessageReq[];

  constructor(data?: PartialMessage<DownloadSpecifiedMessagesReq>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "api.v0alpha.DownloadSpecifiedMessagesReq";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): DownloadSpecifiedMessagesReq;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): DownloadSpecifiedMessagesReq;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): DownloadSpecifiedMessagesReq;

  static equals(a: DownloadSpecifiedMessagesReq | PlainMessage<DownloadSpecifiedMessagesReq> | undefined, b: DownloadSpecifiedMessagesReq | PlainMessage<DownloadSpecifiedMessagesReq> | undefined): boolean;
}

/**
 * @generated from message api.v0alpha.DownloadSpecifiedMessagesReq.MessageReq
 */
export declare class DownloadSpecifiedMessagesReq_MessageReq extends Message<DownloadSpecifiedMessagesReq_MessageReq> {
  /**
  ...
  constructor(data?: PartialMessage<DownloadSpecifiedMessagesReq_MessageReq>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "api.v0alpha.DownloadSpecifiedMessagesReq.MessageReq";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): DownloadSpecifiedMessagesReq_MessageReq;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): DownloadSpecifiedMessagesReq_MessageReq;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): DownloadSpecifiedMessagesReq_MessageReq;

  static equals(a: DownloadSpecifiedMessagesReq_MessageReq | PlainMessage<DownloadSpecifiedMessagesReq_MessageReq> | undefined, b: DownloadSpecifiedMessagesReq_MessageReq | PlainMessage<DownloadSpecifiedMessagesReq_MessageReq> | undefined): boolean;
}

/**
 * @generated from message api.v0alpha.DownloadSpecifiedMessagesRes
 */
export declare class DownloadSpecifiedMessagesRes extends Message<DownloadSpecifiedMessagesRes> {
  /**
   * @generated from field: string url = 1;
   */
  url: string;

  constructor(data?: PartialMessage<DownloadSpecifiedMessagesRes>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "api.v0alpha.DownloadSpecifiedMessagesRes";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): DownloadSpecifiedMessagesRes;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): DownloadSpecifiedMessagesRes;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): DownloadSpecifiedMessagesRes;

  static equals(a: DownloadSpecifiedMessagesRes | PlainMessage<DownloadSpecifiedMessagesRes> | undefined, b: DownloadSpecifiedMessagesRes | PlainMessage<DownloadSpecifiedMessagesRes> | undefined): boolean;
}

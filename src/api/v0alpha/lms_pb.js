...
import { Duration, Int64Value, proto3, StringValue, Timestamp } from "@bufbuild/protobuf";
...
export const Element = proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 17, name: "created_date", kind: "message", T: Timestamp },
    { no: 18, name: "last_edited", kind: "message", T: Timestamp },
...
export const History = proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 14, name: "upload_ts", kind: "message", T: Timestamp },
    { no: 15, name: "started_ts", kind: "message", T: Timestamp },
    { no: 16, name: "finished_ts", kind: "message", T: Timestamp },
...
export const ConsentExportProcess = proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 31, name: "expiration_date", kind: "message", T: Timestamp, oneof: "expiration" },
...
export const P3ExportProcess = proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 16, name: "start_time", kind: "message", T: Timestamp },
    { no: 17, name: "end_time", kind: "message", T: Timestamp },
...
export const Event = proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 10, name: "upload_ts", kind: "message", T: Timestamp },
    { no: 11, name: "started_ts", kind: "message", T: Timestamp },
    { no: 12, name: "finished_ts", kind: "message", T: Timestamp },
    { no: 13, name: "backoff_till", kind: "message", T: Timestamp },
...
export const ViewQueueReq = proto3.makeMessageType(
  ...
  () => [
    { no: 1, name: "newer_than", kind: "message", T: Timestamp },
    { no: 2, name: "no_newer_than", kind: "message", T: Timestamp },
...
export const CollectionMetadata = proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 9, name: "last_queried", kind: "message", T: Timestamp },
    ...
    { no: 14, name: "last_searched", kind: "message", T: Timestamp },
  ],
);
...
export const CjsSecureSearchCriteriaMetadata = proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 11, name: "last_updated", kind: "message", T: Timestamp },
  ],
);

...
export const DiagnosticCode = proto3.makeEnum(
  ...
  [
    ...
    {no: 53, name: "INVALID_TOUR_PATTERN"},
    {no: 54, name: "INVALID_TOUR_AGENT_COLLECTION"},
    {no: 55, name: "INVALID_TOUR_SHIFT_INSTANCE_CONFIG"},
    {no: 56, name: "INVALID_TOUR_SHIFT_SEGMENT_CONFIG"},
    {no: 57, name: "TOUR_SHIFT_SEGMENT_CONFIG_OVERLAP"},
    {no: 58, name: "TOUR_SHIFT_SEGMENT_CONFIG_DOES_NOT_FIT"},
    {no: 59, name: "TOUR_SHIFT_INSTANCE_CONFIG_OVERLAP"},
    {no: 60, name: "WEEK_PATTERN_NUMBERS_NOT_UNIQUE_IN_TOUR_WEEK_PATTERNS"},
    {no: 61, name: "WFM_AGENT_SIDS_NOT_UNIQUE_IN_TOUR_AGENT_COLLECTIONS"},
    {no: 62, name: "FIST_WEEK_PATTERN_NUMBERS_NOT_UNIQUE_IN_TOUR_AGENT_COLLECTIONS"},
    {no: 63, name: "FIRST_WEEK_PATTERN_NUMBERS_NOT_FOUND_IN_TOUR_WEEK_PATTERNS"},
  ],
);

...
export declare enum DiagnosticCode {
   ...
   *
   * @generated from enum value: SHIFT_TEMPLATE_HAS_NO_ASSOCIATED_SCHEDULING_AGENT_GROUPS = 65;
   */
   ...
   *
   * @generated from enum value: ATTEMPT_TO_BUILD_SCHEDULES_FOR_INVALID_PARENT_NODE = 66;
   */

 ...
 */
export const GlobalSystemMessage = proto3.makeMessageType(
  "api.commons.GlobalSystemMessage",
  () => [
    { no: 1, name: "message_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "room_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "status", kind: "enum", T: proto3.getEnumType(MessageStatus) },
    ...
    { no: 8, name: "config", kind: "message", T: RoomConfig },
  ],
);

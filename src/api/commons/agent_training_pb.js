 ...
 */
export const LearningOpportunityStatus = /*@__PURE__*/ proto3.makeEnum(
 ...
 */
export const LearningOpportunityOrigin = /*@__PURE__*/ proto3.makeEnum(
 ...
 */
export const LearningOpportunity = /*@__PURE__*/ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 16, name: "evaluation_id", kind: "scalar", T: 3 /* ScalarType.INT64 */, oneof: "origin_identifier" },
    { no: 17, name: "auto_evaluation_id", kind: "scalar", T: 3 /* ScalarType.INT64 */, oneof: "origin_identifier" },
  ],
);
 ...
 */
export const CallIdentifier = /*@__PURE__*/ proto3.makeMessageType(

...
export const OmniNodeInject = proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "data", kind: "scalar", T: 9 /* ScalarType.STRING */, opt: true },
  ],
);
...
export const OmniNodeSendMessage = proto3.makeMessageType(
  ...
  () => [
    { no: 1, name: "prompt", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "options_key", kind: "scalar", T: 9 /* ScalarType.STRING */, opt: true },
  ],
);
...
export const OmniNodeCompare = proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "options_key", kind: "scalar", T: 9 /* ScalarType.STRING */, opt: true },
  ],
);

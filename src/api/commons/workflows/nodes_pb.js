...
import { OmniNodeBranching, OmniNodeEndConversation, OmniNodeError, OmniNodePrompt, OmniNodeScrublist, OmniNodeSendMessage, OmniNodeSetSkill, OmniNodeToAgent, OmniNodeToMatcher, OmniNodeUserInput, OmniNodeWebhook } from "./omni_pb.js";
...
export const NodeDefinition = proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 209, name: "omni_to_matcher", kind: "message", T: OmniNodeToMatcher, oneof: "definition" },

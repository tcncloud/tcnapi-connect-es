...
import { OmniNodeCompare, OmniNodeError, OmniNodeInject, OmniNodeInjectMessage, OmniNodePrompt, OmniNodeSendMessage, OmniNodeSetSkill, OmniNodeStore, OmniNodeToAgent } from "./omni_pb.js";
...
export const NodeDefinition = proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 205, name: "omni_inject", kind: "message", T: OmniNodeInject, oneof: "definition" },
    { no: 206, name: "omni_inject_message", kind: "message", T: OmniNodeInjectMessage, oneof: "definition" },
    { no: 207, name: "omni_send_message", kind: "message", T: OmniNodeSendMessage, oneof: "definition" },
    { no: 208, name: "omni_store", kind: "message", T: OmniNodeStore, oneof: "definition" },
    { no: 209, name: "omni_compare", kind: "message", T: OmniNodeCompare, oneof: "definition" },

...
export declare class OmnichannelCreateCampaignEvent extends Message<OmnichannelCreateCampaignEvent> {
   ...
   *
   * @generated from field: int64 campaign_sid = 5 [jstype = JS_STRING];
   */
  campaignSid: string;
   ...
   * project identifier
   *
   * @generated from field: int64 project_sid = 7 [jstype = JS_STRING];
   */
  projectSid: string;
...
export declare class OmnichannelCustomerTextMessageEvent extends Message<OmnichannelCustomerTextMessageEvent> {
   ...
   *
   * @generated from field: int64 conversation_sid = 3 [jstype = JS_STRING];
   */
  conversationSid: string;
...
export declare class OmnichannelScheduleModuleEvent extends Message<OmnichannelScheduleModuleEvent> {
   ...
   * module id
   *
   * @generated from field: int64 module_sid = 1 [jstype = JS_STRING];
   */
  moduleSid: string;

...
export const EventType = proto3.makeEnum(
  ...
  [
    ...
    {no: 901, name: "LMS_PIPELINE_NO_OUTPUT_EVENT"},
    {no: 902, name: "LMS_PIPELINE_SUCCESSFUL_EVENT"},
    {no: 1000, name: "EVENT_TYPE_BILLING_COMMIT_BILLING_PLAN"},
    {no: 1001, name: "EVENT_TYPE_BILLING_CREATE_BILLING_PLAN"},
    {no: 1002, name: "EVENT_TYPE_BILLING_CREATE_INVOICE"},
    {no: 1003, name: "EVENT_TYPE_BILLING_CREATE_RATE_DEFINITION"},
    {no: 1004, name: "EVENT_TYPE_BILLING_DELETE_BILLING_PLAN"},
    {no: 1005, name: "EVENT_TYPE_BILLING_DELETE_INVOICE"},
    {no: 1006, name: "EVENT_TYPE_BILLING_DELETE_RATE_DEFINITION"},
    {no: 1007, name: "EVENT_TYPE_BILLING_EXPORT_INVOICE"},

...
export const EventType = proto3.makeEnum(
  ...
  [
    ...
    {no: 358, name: "OMNICHANNEL_MANUAL_APPROVE_TASK_ACCEPTED"},
    ...
    {no: 1000, name: "EVENT_TYPE_BILLING_CREATE_BILLING_PLAN"},
    {no: 1001, name: "EVENT_TYPE_BILLING_CREATE_INVOICE"},
    {no: 1002, name: "EVENT_TYPE_BILLING_CREATE_RATE_DEFINITION"},
    {no: 1003, name: "EVENT_TYPE_BILLING_DELETE_BILLING_PLAN"},
    {no: 1004, name: "EVENT_TYPE_BILLING_DELETE_INVOICE"},
    {no: 1005, name: "EVENT_TYPE_BILLING_DELETE_RATE_DEFINITION"},
    {no: 1006, name: "EVENT_TYPE_BILLING_EXPORT_INVOICE"},
    {no: 1007, name: "EVENT_TYPE_BILLING_UPDATE_BILLING_PLAN"},
    {no: 1008, name: "EVENT_TYPE_BILLING_UPDATE_INVOICE"},
    {no: 1009, name: "EVENT_TYPE_BILLING_UPDATE_RATE_DEFINITION"},
  ],
);

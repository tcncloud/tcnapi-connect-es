...
export declare class AuditEvent extends Message<AuditEvent> {
  ...
  event: {
     ...
     * transcript saved
     *
     * @generated from field: api.commons.audit.OmnichannelTranscriptSavedEvent omnichannel_transcript_saved_event = 362;
     */
    value: OmnichannelTranscriptSavedEvent;
    case: "omnichannelTranscriptSavedEvent";
  } | {
    /**
     * / Asm events 400

...
export declare class BusinessHours extends Message<BusinessHours> {
   ...
   *
   * @generated from field: string business_hours_id = 6;
   */
   ...
   *
   * @generated from field: string business_hours_name = 7;
   */
   ...
   * The timezone.
   *
   * @generated from field: api.commons.TimeZone timezone = 8;
   */
  timezone: TimeZone;
   ...
   *
   * @generated from field: repeated api.commons.org.DayInterval day_intervals = 9;
   */
...
export declare class TimeOfDay extends Message<TimeOfDay> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "api.commons.org.TimeOfDay";
  static readonly fields: FieldList;
 ...
 */
export declare class DayInterval extends Message<DayInterval> {
  /**
   ...
   *
   * @generated from field: api.commons.org.TimeOfDay start = 2;
   */
  start?: TimeOfDay;
   ...
   *
   * @generated from field: api.commons.org.TimeOfDay end = 3;
   */
  end?: TimeOfDay;

  constructor(data?: PartialMessage<DayInterval>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "api.commons.org.DayInterval";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): DayInterval;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): DayInterval;

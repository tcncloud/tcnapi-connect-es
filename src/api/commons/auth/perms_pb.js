...
export const Permission = proto3.makeEnum(
  ...
  [
    ...
    {no: 250, name: "PERMISSION_SUPPORT_TCN_INSIGHTS_ADMIN", localName: "SUPPORT_TCN_INSIGHTS_ADMIN"},
    {no: 251, name: "PERMISSION_SUPPORT_TCN_DASHBOARDS_ADMIN", localName: "SUPPORT_TCN_DASHBOARDS_ADMIN"},
    ...
    {no: 341, name: "PERMISSION_MANUAL_APPROVE", localName: "MANUAL_APPROVE"},
    {no: 342, name: "PERMISSION_AGENT_PLUGINS_VIEW", localName: "AGENT_PLUGINS_VIEW"},
    {no: 343, name: "PERMISSION_AGENT_HUNTGROUP_INTEGRATIONS_VIEW", localName: "AGENT_HUNTGROUP_INTEGRATIONS_VIEW"},
    {no: 344, name: "PERMISSION_MANUAL_CAMPAIGN", localName: "MANUAL_CAMPAIGN"},
    ...
    {no: 605, name: "PERMISSION_INSIGHTS_INSIGHT_VIEW", localName: "INSIGHTS_INSIGHT_VIEW"},
    {no: 606, name: "PERMISSION_INSIGHTS_INSIGHT_EDIT", localName: "INSIGHTS_INSIGHT_EDIT"},
    {no: 607, name: "PERMISSION_INSIGHTS_DASHBOARD_VIEW", localName: "INSIGHTS_DASHBOARD_VIEW"},
    {no: 608, name: "PERMISSION_INSIGHTS_DASHBOARD_EDIT", localName: "INSIGHTS_DASHBOARD_EDIT"},
    {no: 700, name: "PERMISSION_ROOM303", localName: "ROOM303"},
    {no: 701, name: "PERMISSION_ROOM303_MEMBER", localName: "ROOM303_MEMBER"},
    {no: 702, name: "PERMISSION_ROOM303_SUPERVISOR", localName: "ROOM303_SUPERVISOR"},
    ...
    {no: 1501, name: "PERMISSION_AGENT_PORTAL", localName: "AGENT_PORTAL"},
    ...
    {no: 1604, name: "PERMISSION_SCORECARDS_LEARNING_OPPORTUNITIES", localName: "SCORECARDS_LEARNING_OPPORTUNITIES"},
    ...
    {no: 4110, name: "PERMISSION_PBX_SOFTPHONE_WIDGET", localName: "PBX_SOFTPHONE_WIDGET"},
    {no: 4199, name: "PERMISSION_NEWSROOM_VIEW", localName: "NEWSROOM_VIEW"},

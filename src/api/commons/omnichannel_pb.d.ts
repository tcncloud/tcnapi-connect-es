...
export declare class OmniCampaign extends Message<OmniCampaign> {
   ...
   *
   * @generated from field: int64 project_sid = 10;
   */
  projectSid: bigint;
...
export declare class OmniCampaignModule extends Message<OmniCampaignModule> {
   ...
   *
   * @generated from field: int64 campaign_module_sid = 1;
   */
...
export declare class ConversationCollectedData_Item extends Message<ConversationCollectedData_Item> {
   ...
   *
   * @generated from field: int64 conversation_collected_data_sid = 1;
   */
  conversationCollectedDataSid: bigint;

  /**
   * the id of the conversation
   *
   * @generated from field: int64 conversation_sid = 2;
   */
...
export declare class OmniMessage extends Message<OmniMessage> {
   ...
   *
   * @generated from field: int64 message_sid = 1;
   */
  messageSid: bigint;
   ...
   *
   * @generated from field: int64 campaign_sid = 17;
   */
  campaignSid: bigint;
...
export declare class OmniConversation extends Message<OmniConversation> {
   ...
   *
   * @generated from field: int64 campaign_sid = 10;
   */
  campaignSid: bigint;
   ...
   *
   * @generated from field: int64 campaign_module_sid = 19;
   */
  campaignModuleSid: bigint;
...
export declare class OmniConversationAssignment extends Message<OmniConversationAssignment> {
   ...
   * primary key or internal identifier for conversation
   *
   * @generated from field: int64 conversation_assignment_sid = 1;
   */
  conversationAssignmentSid: bigint;
...
export declare class ContactEntry extends Message<ContactEntry> {
   ...
   *
   * @generated from field: int64 contact_entry_sid = 1;
   */
  contactEntrySid: bigint;

  /**
   * the identifier of the contact list
   *
   * @generated from field: int64 contact_list_sid = 2;
   */
  contactListSid: bigint;
...
export declare class OmniTask extends Message<OmniTask> {
   ...
   *
   * @generated from field: int64 campaign_sid = 6;
   */
  campaignSid: bigint;
...
export declare class OmniDataField extends Message<OmniDataField> {
   ...
   *
   * @generated from field: int64 field_sid = 1;
   */
  fieldSid: bigint;
   ...
   *
   * @generated from field: int64 parent_sid = 2;
   */
  parentSid: bigint;

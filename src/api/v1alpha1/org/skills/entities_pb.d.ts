 ...
 */
export declare class AssignUsersRequest extends Message<AssignUsersRequest> {
  /**
  ...
  constructor(data?: PartialMessage<AssignUsersRequest>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "api.v1alpha1.org.skills.AssignUsersRequest";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): AssignUsersRequest;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): AssignUsersRequest;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): AssignUsersRequest;

  static equals(a: AssignUsersRequest | PlainMessage<AssignUsersRequest> | undefined, b: AssignUsersRequest | PlainMessage<AssignUsersRequest> | undefined): boolean;
}
 ...
 */
export declare class AssignUsersResponse extends Message<AssignUsersResponse> {
  constructor(data?: PartialMessage<AssignUsersResponse>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "api.v1alpha1.org.skills.AssignUsersResponse";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): AssignUsersResponse;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): AssignUsersResponse;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): AssignUsersResponse;

  static equals(a: AssignUsersResponse | PlainMessage<AssignUsersResponse> | undefined, b: AssignUsersResponse | PlainMessage<AssignUsersResponse> | undefined): boolean;
}

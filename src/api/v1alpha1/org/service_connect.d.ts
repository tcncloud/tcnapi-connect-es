...
export declare const Org: {
  ...
  readonly methods: {
     ...
     *
     * @generated from rpc api.v1alpha1.org.Org.SendUserEmailPasswordReset
     */
    readonly sendUserEmailPasswordReset: {
      readonly name: "SendUserEmailPasswordReset",
      readonly I: typeof SendUserEmailPasswordResetRequest,
      readonly O: typeof SendUserEmailPasswordResetResponse,
      readonly kind: MethodKind.Unary,
    },
    /**

...
export declare class TransferConfig extends Message<TransferConfig> {
   ...
   * snowflake id
   *
   * @generated from field: int64 sid = 1 [jstype = JS_STRING];
   */
  sid: string;
...
export declare class History extends Message<History> {
  ...
  /**
   * @generated from field: int64 transfer_config_sid = 4 [jstype = JS_STRING];
   */
  ...
  /**
   * @generated from field: int64 transaction_sid = 17 [jstype = JS_STRING];
   */
...
export declare class DeliveryDefinition extends Message<DeliveryDefinition> {
  /**
   * @generated from field: int64 delivery_definition_sid = 1 [jstype = JS_STRING];
   */

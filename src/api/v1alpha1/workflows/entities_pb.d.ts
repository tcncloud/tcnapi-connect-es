 ...
 *
 * @generated from message api.v1alpha1.workflows.FlowDefinition
 */
export declare class FlowDefinition extends Message$1<FlowDefinition> {
  ...
  /**
   * @generated from field: repeated api.v1alpha1.workflows.NodeDefinition nodes = 10;
   */
  ...
  static readonly typeName = "api.v1alpha1.workflows.FlowDefinition";
...
/**
 * @generated from message api.v1alpha1.workflows.FlowState
 */
export declare class FlowState extends Message$1<FlowState> {
  /**
   * @generated from field: api.v1alpha1.workflows.Envelope envelope = 1;
   */
  envelope?: Envelope;

  /**
   * @generated from field: api.v1alpha1.workflows.State state = 2;
   */
  state?: State;

  /**
   * @generated from field: api.v1alpha1.workflows.Payload payload = 100;
   */
  payload?: Payload;
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "api.v1alpha1.workflows.FlowState";
  static readonly fields: FieldList;
...
/**
 * @generated from message api.v1alpha1.workflows.Envelope
 */
export declare class Envelope extends Message$1<Envelope> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "api.v1alpha1.workflows.Envelope";
  static readonly fields: FieldList;
...
/**
 * @generated from message api.v1alpha1.workflows.State
 */
export declare class State extends Message$1<State> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "api.v1alpha1.workflows.State";
  static readonly fields: FieldList;
...
/**
 * @generated from message api.v1alpha1.workflows.Payload
 */
export declare class Payload extends Message$1<Payload> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "api.v1alpha1.workflows.Payload";
  static readonly fields: FieldList;
...
/**
 * @generated from message api.v1alpha1.workflows.Message
 */
export declare class Message extends Message$1<Message> {
  /**
   * @generated from oneof api.v1alpha1.workflows.Message.payload
   */
  payload: {
    /**
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "api.v1alpha1.workflows.Message";
  static readonly fields: FieldList;

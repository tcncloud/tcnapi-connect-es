...
import type { GlobalSystemMessage, Message as Message$1, MessageStat } from "../../commons/room303_pb.js";
...
/**
 * @generated from message api.v1alpha1.room303.ListNewsRoomGlobalMessagesRequest
 */
export declare class ListNewsRoomGlobalMessagesRequest extends Message<ListNewsRoomGlobalMessagesRequest> {
  constructor(data?: PartialMessage<ListNewsRoomGlobalMessagesRequest>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "api.v1alpha1.room303.ListNewsRoomGlobalMessagesRequest";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ListNewsRoomGlobalMessagesRequest;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ListNewsRoomGlobalMessagesRequest;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ListNewsRoomGlobalMessagesRequest;

  static equals(a: ListNewsRoomGlobalMessagesRequest | PlainMessage<ListNewsRoomGlobalMessagesRequest> | undefined, b: ListNewsRoomGlobalMessagesRequest | PlainMessage<ListNewsRoomGlobalMessagesRequest> | undefined): boolean;
}

/**
 * @generated from message api.v1alpha1.room303.ListNewsRoomGlobalMessagesResponse
 */
export declare class ListNewsRoomGlobalMessagesResponse extends Message<ListNewsRoomGlobalMessagesResponse> {
  /**
   * @generated from field: repeated api.commons.GlobalSystemMessage messages = 1;
   */
  messages: GlobalSystemMessage[];

  constructor(data?: PartialMessage<ListNewsRoomGlobalMessagesResponse>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "api.v1alpha1.room303.ListNewsRoomGlobalMessagesResponse";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ListNewsRoomGlobalMessagesResponse;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ListNewsRoomGlobalMessagesResponse;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ListNewsRoomGlobalMessagesResponse;

  static equals(a: ListNewsRoomGlobalMessagesResponse | PlainMessage<ListNewsRoomGlobalMessagesResponse> | undefined, b: ListNewsRoomGlobalMessagesResponse | PlainMessage<ListNewsRoomGlobalMessagesResponse> | undefined): boolean;
}

/**
 * @generated from message api.v1alpha1.room303.SendNewsRoomGlobalMessageRequest
 */
export declare class SendNewsRoomGlobalMessageRequest extends Message<SendNewsRoomGlobalMessageRequest> {
  /**
   * @generated from field: api.commons.GlobalSystemMessage message = 1;
   */
  message?: GlobalSystemMessage;

  constructor(data?: PartialMessage<SendNewsRoomGlobalMessageRequest>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "api.v1alpha1.room303.SendNewsRoomGlobalMessageRequest";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): SendNewsRoomGlobalMessageRequest;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): SendNewsRoomGlobalMessageRequest;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): SendNewsRoomGlobalMessageRequest;

  static equals(a: SendNewsRoomGlobalMessageRequest | PlainMessage<SendNewsRoomGlobalMessageRequest> | undefined, b: SendNewsRoomGlobalMessageRequest | PlainMessage<SendNewsRoomGlobalMessageRequest> | undefined): boolean;
}

/**
 * @generated from message api.v1alpha1.room303.SendNewsRoomGlobalMessageResponse
 */
export declare class SendNewsRoomGlobalMessageResponse extends Message<SendNewsRoomGlobalMessageResponse> {
  /**
   * @generated from field: string room_id = 1;
   */
  roomId: string;

  constructor(data?: PartialMessage<SendNewsRoomGlobalMessageResponse>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "api.v1alpha1.room303.SendNewsRoomGlobalMessageResponse";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): SendNewsRoomGlobalMessageResponse;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): SendNewsRoomGlobalMessageResponse;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): SendNewsRoomGlobalMessageResponse;

  static equals(a: SendNewsRoomGlobalMessageResponse | PlainMessage<SendNewsRoomGlobalMessageResponse> | undefined, b: SendNewsRoomGlobalMessageResponse | PlainMessage<SendNewsRoomGlobalMessageResponse> | undefined): boolean;
}

...
import { GlobalSystemMessage, Message, MessageStat } from "../../commons/room303_pb.js";
 ...
 */
export const ListNewsRoomGlobalMessagesRequest = proto3.makeMessageType(
  "api.v1alpha1.room303.ListNewsRoomGlobalMessagesRequest",
  [],
);
 ...
 */
export const ListNewsRoomGlobalMessagesResponse = proto3.makeMessageType(
  "api.v1alpha1.room303.ListNewsRoomGlobalMessagesResponse",
  () => [
    { no: 1, name: "messages", kind: "message", T: GlobalSystemMessage, repeated: true },
  ],
);
 ...
 */
export const SendNewsRoomGlobalMessageRequest = proto3.makeMessageType(
  "api.v1alpha1.room303.SendNewsRoomGlobalMessageRequest",
  () => [
    { no: 1, name: "message", kind: "message", T: GlobalSystemMessage },
  ],
);
 ...
 */
export const SendNewsRoomGlobalMessageResponse = proto3.makeMessageType(
  "api.v1alpha1.room303.SendNewsRoomGlobalMessageResponse",
  () => [
    { no: 1, name: "room_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ],
);

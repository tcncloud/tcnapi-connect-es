...
import { DayFilter, DeliveryOptions, DeliveryTimes, FilenamePart, FormatOptions, TimePeriod } from "../../commons/bireportgenerator_pb.js";
...
export const ReportJob = /*@__PURE__*/ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 19, name: "filename_parts", kind: "message", T: FilenamePart, repeated: true },
  ],
);

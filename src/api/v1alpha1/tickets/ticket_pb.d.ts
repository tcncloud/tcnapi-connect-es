...
export declare class CloseTicketReq extends Message<CloseTicketReq> {
   ...
   *
   * @generated from field: int64 from_status = 3 [jstype = JS_STRING];
   */
  fromStatus: string;
...
export declare class CloseTicketActionRequest extends Message<CloseTicketActionRequest> {
  ...
  /**
   * @generated from field: int64 ticket_id = 2 [jstype = JS_STRING];
   */
  ticketId: string;
...
export declare class ChangeTicketStatusRequest extends Message<ChangeTicketStatusRequest> {
  /**
   * @generated from field: int64 ticket_id = 1 [jstype = JS_STRING];
   */
  ticketId: string;

  /**
   * @generated from field: int64 status_id = 2 [jstype = JS_STRING];
   */
  statusId: string;

 ...
 *
 * @generated from message api.v1alpha1.cfg.GetWebAgentConfigReq
 */
export declare class GetWebAgentConfigReq extends Message<GetWebAgentConfigReq> {
  /**
  ...
  constructor(data?: PartialMessage<GetWebAgentConfigReq>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "api.v1alpha1.cfg.GetWebAgentConfigReq";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): GetWebAgentConfigReq;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): GetWebAgentConfigReq;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): GetWebAgentConfigReq;

  static equals(a: GetWebAgentConfigReq | PlainMessage<GetWebAgentConfigReq> | undefined, b: GetWebAgentConfigReq | PlainMessage<GetWebAgentConfigReq> | undefined): boolean;
}

/**
 * The configuration for a web agent.
 *
 * @generated from message api.v1alpha1.cfg.WebAgent
 */
export declare class WebAgent extends Message<WebAgent> {
  /**
   * @generated from field: api.v1alpha1.cfg.WebAgent.OpenSips open_sips = 1;
   */
  openSips?: WebAgent_OpenSips;

  /**
   * @generated from field: api.v1alpha1.cfg.WebAgent.EnginePriority engine_priority = 2;
   */
  ...
  /**
   * @generated from field: api.v1alpha1.cfg.WebAgent.Server server = 10;
   */
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "api.v1alpha1.cfg.WebAgent";
  static readonly fields: FieldList;
...
/**
 * @generated from message api.v1alpha1.cfg.WebAgent.OpenSips
 */
export declare class WebAgent_OpenSips extends Message<WebAgent_OpenSips> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "api.v1alpha1.cfg.WebAgent.OpenSips";
  static readonly fields: FieldList;
...
/**
 * @generated from message api.v1alpha1.cfg.WebAgent.EnginePriority
 */
export declare class WebAgent_EnginePriority extends Message<WebAgent_EnginePriority> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "api.v1alpha1.cfg.WebAgent.EnginePriority";
  static readonly fields: FieldList;
...
/**
 * @generated from message api.v1alpha1.cfg.WebAgent.Server
 */
export declare class WebAgent_Server extends Message<WebAgent_Server> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "api.v1alpha1.cfg.WebAgent.Server";
  static readonly fields: FieldList;

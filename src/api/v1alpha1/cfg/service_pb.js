 ...
 */
export const GetWebAgentConfigReq = /*@__PURE__*/ proto3.makeMessageType(
 ...
 */
export const WebAgent = /*@__PURE__*/ proto3.makeMessageType(
 ...
 */
export const WebAgent_OpenSips = /*@__PURE__*/ proto3.makeMessageType(
  "api.v1alpha1.cfg.WebAgent.OpenSips",
  () => [
 ...
 */
export const WebAgent_EnginePriority = /*@__PURE__*/ proto3.makeMessageType(
  "api.v1alpha1.cfg.WebAgent.EnginePriority",
  () => [
 ...
 */
export const WebAgent_Server = /*@__PURE__*/ proto3.makeMessageType(
  "api.v1alpha1.cfg.WebAgent.Server",
  () => [

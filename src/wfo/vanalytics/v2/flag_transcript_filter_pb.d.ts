...
export declare class ListFlagTranscriptFiltersRequest extends Message<ListFlagTranscriptFiltersRequest> {
  ...
  static readonly typeName = "wfo.vanalytics.v2.ListFlagTranscriptFiltersRequest";
...
export declare class ListFlagTranscriptFiltersResponse extends Message<ListFlagTranscriptFiltersResponse> {
  /**
   * @generated from field: repeated wfo.vanalytics.v2.FlagTranscriptFilter flag_transcript_filters = 1;
   */
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "wfo.vanalytics.v2.ListFlagTranscriptFiltersResponse";
  static readonly fields: FieldList;
...
export declare class FlagTranscriptFilter extends Message<FlagTranscriptFilter> {
   ...
   *
   * @generated from field: wfo.vanalytics.v2.FlagSnapshot flag_snapshot = 1;
   */
   ...
   *
   * @generated from field: wfo.vanalytics.v2.FilterSnapshot filter_snapshot = 2;
   */
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "wfo.vanalytics.v2.FlagTranscriptFilter";
  static readonly fields: FieldList;

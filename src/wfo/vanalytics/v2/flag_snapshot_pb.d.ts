...
export declare class ListFlagSnapshotsRequest extends Message<ListFlagSnapshotsRequest> {
  ...
  static readonly typeName = "wfo.vanalytics.v2.ListFlagSnapshotsRequest";
...
export declare class ListFlagSnapshotsResponse extends Message<ListFlagSnapshotsResponse> {
   ...
   *
   * @generated from field: repeated wfo.vanalytics.v2.FlagSnapshot flag_snapshots = 2;
   */
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "wfo.vanalytics.v2.ListFlagSnapshotsResponse";
  static readonly fields: FieldList;
...
export declare class FlagSnapshot extends Message<FlagSnapshot> {
   ...
   *
   * @generated from field: wfo.vanalytics.v2.FlagSnapshot.BoolExpr bool_expr = 12;
   */
   ...
   *
   * @generated from field: repeated wfo.vanalytics.v2.DnclList dncl_list = 13;
   */
  dnclList: DnclList[];
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "wfo.vanalytics.v2.FlagSnapshot";
  static readonly fields: FieldList;
...
export declare class FlagSnapshot_BoolExpr extends Message<FlagSnapshot_BoolExpr> {
   ...
   *
   * @generated from field: repeated wfo.vanalytics.v2.FlagSnapshot.BoolExpr and = 1;
   */
   ...
   *
   * @generated from field: repeated wfo.vanalytics.v2.FlagSnapshot.BoolExpr or = 2;
   */
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "wfo.vanalytics.v2.FlagSnapshot.BoolExpr";
  static readonly fields: FieldList;
...
export declare class FlagSnapshot_BoolExpr_Filter extends Message<FlagSnapshot_BoolExpr_Filter> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "wfo.vanalytics.v2.FlagSnapshot.BoolExpr.Filter";
  static readonly fields: FieldList;

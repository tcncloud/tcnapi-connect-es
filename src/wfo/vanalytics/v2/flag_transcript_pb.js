 ...
 */
export const FlagReviewStatus = /*@__PURE__*/ proto3.makeEnum(
  "wfo.vanalytics.v2.FlagReviewStatus",
  [
    {no: 0, name: "ANY"},
    {no: 1, name: "TODO"},
    {no: 2, name: "DONE"},
 ...
 */
export const SearchFlagTranscriptsRequest = /*@__PURE__*/ proto3.makeMessageType(
  "wfo.vanalytics.v2.SearchFlagTranscriptsRequest",
  () => [
 ...
 */
export const SearchFlagTranscriptsRequest_FlagSid = /*@__PURE__*/ proto3.makeMessageType(
  "wfo.vanalytics.v2.SearchFlagTranscriptsRequest.FlagSid",
  () => [
 ...
 */
export const SearchFlagTranscriptsRequest_NotifyGroupId = /*@__PURE__*/ proto3.makeMessageType(
  "wfo.vanalytics.v2.SearchFlagTranscriptsRequest.NotifyGroupId",
  () => [
 ...
 */
export const SearchFlagTranscriptsRequest_ReviewGroupId = /*@__PURE__*/ proto3.makeMessageType(
  "wfo.vanalytics.v2.SearchFlagTranscriptsRequest.ReviewGroupId",
  () => [
    { no: 1, name: "is_null", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
    { no: 2, name: "filter", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
    { no: 3, name: "match", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
 ...
 */
export const SearchFlagTranscriptsResponse = /*@__PURE__*/ proto3.makeMessageType(
  "wfo.vanalytics.v2.SearchFlagTranscriptsResponse",
  () => [
 ...
 */
export const SearchFlagTranscriptsResponse_Hit = /*@__PURE__*/ proto3.makeMessageType(
  "wfo.vanalytics.v2.SearchFlagTranscriptsResponse.Hit",
  () => [

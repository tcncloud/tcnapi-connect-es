...
export declare class CreateFlagRequest extends Message<CreateFlagRequest> {
   ...
   *
   * @generated from field: wfo.vanalytics.v2.Flag flag = 1;
   */
  flag?: Flag;
  ...
  static readonly typeName = "wfo.vanalytics.v2.CreateFlagRequest";
...
export declare class ListFlagsRequest extends Message<ListFlagsRequest> {
  ...
  /**
   * @generated from oneof wfo.vanalytics.v2.ListFlagsRequest.where
   */
  where: {
    /**
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "wfo.vanalytics.v2.ListFlagsRequest";
  static readonly fields: FieldList;
...
export declare class ListFlagsResponse extends Message<ListFlagsResponse> {
   ...
   *
   * @generated from field: repeated wfo.vanalytics.v2.Flag flags = 2;
   */
  flags: Flag[];
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "wfo.vanalytics.v2.ListFlagsResponse";
  static readonly fields: FieldList;
...
export declare class UpdateFlagRequest extends Message<UpdateFlagRequest> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "wfo.vanalytics.v2.UpdateFlagRequest";
  static readonly fields: FieldList;
...
export declare class DeleteFlagRequest extends Message<DeleteFlagRequest> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "wfo.vanalytics.v2.DeleteFlagRequest";
  static readonly fields: FieldList;
...
export declare class DeleteFlagResponse extends Message<DeleteFlagResponse> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "wfo.vanalytics.v2.DeleteFlagResponse";
  static readonly fields: FieldList;
...
export declare class GetFlagRequest extends Message<GetFlagRequest> {
  /**
   * @generated from oneof wfo.vanalytics.v2.GetFlagRequest.where
   */
  where: {
    /**
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "wfo.vanalytics.v2.GetFlagRequest";
  static readonly fields: FieldList;
...
export declare class Flag extends Message<Flag> {
   ...
   *
   * @generated from field: wfo.vanalytics.v2.Flag.BoolExpr bool_expr = 11;
   */
   ...
   *
   * @generated from field: repeated wfo.vanalytics.v2.DnclList dncl_list = 12;
   */
  dnclList: DnclList[];
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "wfo.vanalytics.v2.Flag";
  static readonly fields: FieldList;
...
export declare class Flag_BoolExpr extends Message<Flag_BoolExpr> {
   ...
   *
   * @generated from field: repeated wfo.vanalytics.v2.Flag.BoolExpr and = 1;
   */
  and: Flag_BoolExpr[];
   ...
   *
   * @generated from field: repeated wfo.vanalytics.v2.Flag.BoolExpr or = 2;
   */
  or: Flag_BoolExpr[];
   ...
   *
   * @generated from field: wfo.vanalytics.v2.Flag.BoolExpr.Filter filter = 3;
   */
   ...
   *
   * @generated from field: wfo.vanalytics.v2.Flag.BoolExpr not = 4;
   */
  not?: Flag_BoolExpr;
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "wfo.vanalytics.v2.Flag.BoolExpr";
  static readonly fields: FieldList;
...
export declare class Flag_BoolExpr_Filter extends Message<Flag_BoolExpr_Filter> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "wfo.vanalytics.v2.Flag.BoolExpr.Filter";
  static readonly fields: FieldList;

...
import type { Product } from "./products_pb.js";
...
export declare class Invoice extends Message<Invoice> {
   ...
   * a separate item.
   *
   * @generated from field: repeated data.billing.v1alpha1.InvoiceItem items = 6;
   */
  items: InvoiceItem[];
  ...
  static readonly typeName = "data.billing.v1alpha1.Invoice";
...
export declare class InvoiceItem extends Message<InvoiceItem> {
   ...
   *
   * @generated from field: data.billing.v1alpha1.Product product = 3;
   */
  product: Product;
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "data.billing.v1alpha1.InvoiceItem";
  static readonly fields: FieldList;

...
// @generated from file data/billing/v1alpha1/plans.proto (package data.billing.v1alpha1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message data.billing.v1alpha1.BillingPlan
 */
export declare class BillingPlan extends Message<BillingPlan> {
   ...
   *
   * @generated from field: repeated data.billing.v1alpha1.RateDefinition rate_definitions = 7;
   */
  ...
  static readonly typeName = "data.billing.v1alpha1.BillingPlan";
